...
const PACKAGES: Package[] = [
  {
    ...
    addons: [
      { id: 'photo',    label: 'Photography Shoot',        desc: 'Professional photos of your storefront, interior, and products.', oneTime: 300, monthly: 0 },
      { id: 'drone',    label: 'Drone Footage',            desc: 'Aerial video and photos of your location.',                        oneTime: 200, monthly: 0 },
