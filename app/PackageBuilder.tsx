...
const PACKAGES: Package[] = [
  {
    ...
    features: [
      ...
      { label: 'Google Business Profile',           yes: false },
      { label: 'Local SEO',                         yes: true  },
      { label: 'Social media setup (FB/IG/LinkedIn)', yes: false },
    ...
    addons: [
      { id: 'gmb',     label: 'Google Business Profile',          desc: 'We claim, set up, and optimize your Google listing so customers can find you on Maps.', oneTime: 150, monthly: 0 },
      { id: 'social',  label: 'Social Media Setup (FB/IG/LinkedIn)', desc: 'Profiles created and optimized with initial branded content.',                      oneTime: 200, monthly: 0 },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Social media setup (FB/IG/LinkedIn)', yes: true  },
    ...
    included: [
      ...
      'Full local SEO',
      'Social media setup (FB/IG/LinkedIn)',
      'Review system setup',
    ],
    addons: [
      { id: 'booking', label: 'Online Booking System',  desc: 'Customers can schedule appointments directly on your site.',                      oneTime: 125, monthly: 0 },
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px', marginBottom: '3px' }}>
                      ...
                      <span style={{ fontWeight: 800, fontSize: '13px', color: 'var(--sky-deep)', whiteSpace: 'nowrap' }}>
                        {addon.priceLabel ? `+${addon.priceLabel}` : addon.oneTime > 0 ? `+${fmt(addon.oneTime)}` : ''}{!addon.priceLabel && addon.monthly > 0 ? `+${fmt(addon.monthly)}/mo` : ''}
                      </span>
                    </div>
